// The following will generate the base patient record and associated checkup objects. Using a combination of aggregations (see extract_checkups_and_add_patient_id.mongodb)
// and manual data cleaning, you can arrive at the desired record shape. For our project, we added an additional patient_id to the patient and each checkup record, 
// made the doctors notes more verbose, broke out blood_pressure out into two objects, and changed certain data types to Int32 to allow for visualizations. You can find a
// sample of each final record in this repo.
